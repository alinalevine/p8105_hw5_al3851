...
balt_phat = homicide_baltimore %>%
  mutate(phat = n/sum(n))

balt_unsolved_phat = balt_unsolved$n/sum(homicide_baltimore$n)

balt_prop_test = prop.test(filter(homicide_baltimore, disposition == "unsolved")$n, sum(homicide_baltimore$n))
